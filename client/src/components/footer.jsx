...
function Footer() {
  return (
    <footer className='bg-blue-900 text-white px-6 sm:px-10 py-12 rounded-xl'>
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='border-t border-blue-800 pt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between text-sm'>
