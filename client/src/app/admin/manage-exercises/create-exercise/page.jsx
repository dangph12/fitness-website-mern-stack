...
const exerciseSchema = yup
  .object({
    ...
    tutorial: yup
      .mixed()
      .required('Tutorial image is required')
...
const CreateExercise = () => {
  ...
  // Fetch muscles & equipments lists on mount
  useEffect(() => {
          ...
          <form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
            ...
            <div className='space-y-2'>
              <Label htmlFor='tutorial'>
                Tutorial Image/GIF <span className='text-red-500'>*</span>
              </Label>
              {!tutorialPreview ? (
                <div
                  className={`border-2 border-dashed rounded-lg p-6 text-center hover:border-gray-400 transition-colors ${errors.tutorial ? 'border-red-500' : 'border-gray-300'}`}
                >
                  <input
                    id='tutorial'
                    type='file'
                  ...
                  >
                    ...
                    <span className='text-sm text-gray-600'>
                      Click to upload tutorial image (GIF, JPG, PNG, WEBP)
                    </span>
            ...
            <div className='space-y-2'>
              ...
              {referencesLoading ? (
                ...
                <div
                  className={`border rounded-lg p-3 max-h-48 overflow-y-auto ${errors.muscles ? 'border-red-500' : ''}`}
                >
            ...
            <div className='space-y-2'>
              ...
              {referencesLoading ? (
                ...
                <div
                  className={`border rounded-lg p-3 max-h-48 overflow-y-auto ${errors.equipments ? 'border-red-500' : ''}`}
                >
            ...
            <div className='flex gap-4 pt-4'>
              ...
              <Button type='submit' disabled={loading || referencesLoading}>
