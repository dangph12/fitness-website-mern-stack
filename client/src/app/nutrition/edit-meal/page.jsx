...
import FoodList from '../../../components/food-list'; // Make sure FoodList is imported
...
const EditMealPage = () => {
  ...
  }, [currentMeal]); // This will update when `currentMeal` changes

  // Handle form submission and update meal
  const handleUpdateMeal = async e => {
    e.preventDefault();

    const updatedMeal = { title, mealType, image, foods: selectedFoods };
